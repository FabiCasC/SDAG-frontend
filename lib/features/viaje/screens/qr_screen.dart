...
class _QrScreenState extends ConsumerState<QrScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final trip = MockData.tripHistory.where((t) => t.id == widget.tripId).cast<MockTripHistoryItem?>().firstOrNull;
    ...
    final cacheKey = 'qr_cache_${trip.id}_${trip.qrSeat}';
    final qrData = 'hist_${trip.id}|p_${trip.qrSeat}|${trip.qrSeat}';
    ...
    final (chipBg, chipFg, label) = trip.qrBoarded
